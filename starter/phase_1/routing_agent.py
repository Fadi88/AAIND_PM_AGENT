...
agents = [
    ...
    },
    {
        ...
        "func": lambda x: europe_knowledge_agent.respond(
            x
...
print(f"\nPrompt: {prompt1}")
print(f"Response: {routing_agent.route(prompt1)}")

prompt2 = "Tell me about the history of Rome, Italy"
print(f"\nPrompt: {prompt2}")
print(f"Response: {routing_agent.route(prompt2)}")

prompt3 = "One story takes 2 days, and there are 20 stories"
print(f"\nPrompt: {prompt3}")
print(f"Response: {routing_agent.route(prompt3)}")
