...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        system_prompt = (
            f"You are an action planning agent. Using your knowledge, you extract from the user prompt the steps requested "
            f"to complete the action the user is asking for. You return the steps as a list. "
